...
${OBJECTDIR}/color.o: color.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  color.c  -o ${OBJECTDIR}/color.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/color.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -no-legacy-libc  -mlarge-arrays -menable-large-arrays -O3 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/color.o: color.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/color.o.d 
	@${RM} ${OBJECTDIR}/color.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  color.c  -o ${OBJECTDIR}/color.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/color.o.d"      -mno-eds-warn  -g -omf=elf -no-legacy-libc  -mlarge-arrays -menable-large-arrays -O3 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/color.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
